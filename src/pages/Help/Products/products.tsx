    ...
    <>
      ...
      <Row>
        <Col span={24}>
          <Card>
            <h1>Overview</h1>
            <p>Custom Product Fields are found in a tab in the Products Configuration Window. This is not something that Extensiv Order Manager uses internally, it exists only for users who want to add an extra piece of data about their products that Extensiv Order Manager does not natively have a field for. These fields are completely customizable.</p>
            <p>This feature behaves similarly to the <a href="https://help.extensiv.com/om-orders/custom-fields-for-orders-custom-columns" className='helplink'>Custom Fields feature in the Orders Module</a>, but for Products.</p>
            <Divider />
            ...
            <ol>
              <li>
                ...
                <Alert
                    message="NOTE"
                    description={
                      <p>This table is going to be empty the first time. And <strong>everything you add here is going to be accessible across all products</strong>.</p>
                    }
                    type="info"
                />
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-14%2Bat%2B9.53.58%2BAM.png' style={{ width: 900 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>You can both <strong>Configure</strong> new/existing Field Types, as well as set custom field values for your product.<br />To Configure, Create, or Deactivate a Field Type, click the <strong>Configure Field Types</strong> button seen below. Make your edits, then click the <strong>Save</strong> button.<br /><strong>Ex:</strong> <i>Fragile, Contains Liquid, Flammable,</i> etc.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-19%2Bat%2B11.21.56%2BAM.png' style={{ width: 900 }} />
                <br /><br /><br />
                ...
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-19%2Bat%2B11.32.04%2BAM.png' style={{ width: 900 }} />
                <br /><br /><br />
                ...
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-19%2Bat%2B11.33.20%2BAM.png' style={{ width: 900 }} />
                <br /><br /><br />
                <Alert
                    message="NOTE"
                    description={
                      <p>When you deactivate a field and save, that doesn’t remove it from all the products that already use it. This only prevents it from being added to another product.</p>
                    }
                    type="info"
                />
                <br />
              ...
              <li>
                ...
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-19%2Bat%2B11.42.38%2BAM.png' style={{ width: 900 }} />
                <br /><br /><br />
                <Alert
                    message="NOTE"
                    description={
                      <p>You can see a quick view of the Fields and Values set for a Master SKU in the lower-right corner section under the Fields tab.</p>
                    }
                    type="info"
                />
                <br /><br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-19%2Bat%2B11.13.11%2BAM.png' style={{ width: 900 }} />
                <br /><br /><br />
              </li>
            </ol>
            <Divider />
            ...
            <p>Custom fields that are <strong>active</strong> will be exported by default, regardless of whether <i>Show on Grid</i> is checked. If a field is inactive, it won’t be included in this export. No need to configure anything here.</p>
            <h1>Custom Product Export</h1>
            <p>The user can add custom fields to their custom product export just like adding any other field to the custom export. Custom fields will only show up in the field list if they are active, but if a user adds a custom field to their export settings and then deactivates the field, it will still show up in their custom export – they will have to manually remove it from their export settings to remove it from the export.</p>
            <h1>Custom Bundle / Kit Export</h1>
            <p>This works exactly the same way as the <strong>custom product export</strong>, except with the caveat that custom fields will be exported on a <i>per bundled</i> product basis – meaning that only the custom fields of the individual bundled items will be exported, not the custom fields of the bundle itself.</p>
            <p><strong>In order to export custom fields for the bundle itself, the user must also select “Bundle [Custom Field Name]” from the dropdown.</strong><br/> When exported, this value will be the same for all bundled item rows within a given bundle.</p>
            <h1>Import Custom Fields</h1>
            <ol>
              <li>
                <p>Custom fields can be imported through a new UI option in the “Import/Export” dropdown in the Products module:</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-14%2Bat%2B2.13.44%2BPM.png' style={{ width: 700 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>From here, you should see a screen prompting you to upload a file for import. <strong>This file must be in Excel format</strong>. You can download a template file from the link provided on the screen.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-14%2Bat%2B2.07.39%2BPM.png' style={{ width: 900 }} />
                <br /><br /><br />
                ...
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-19%2Bat%2B11.47.08%2BAM.png' style={{ width: 900 }} />
                <br /><br /><br />
                <p>The above spreadsheet's values would populate as shown below using the default values and formatting alone for a single Master SKU. Cell C2 uses the "General" format, and Cell C3 uses the "Custom" format.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-19%2Bat%2B11.13.11%2BAM%2B_1_.png' style={{ width: 1000 }} />
                <br /><br /><br />
                <Alert
                    message="NOTE"
                    description={
                      <p>Formatting such as dates, capitalization, etc. depends on the Cell Type/Format in Excel. If upon import, your Custom Field Values do not populate exactly as expected, check the format of the cells in Column C. General formatting will affect the imported value differently than "Text" or specified Date formatting.</p>
                    }
                    type="info"
                />
                <br /><br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-19%2Bat%2B11.19.18%2BAM.png' style={{ width: 400 }} />
                <br /><br /><br />
              </li>
              <li>
            ...
            <br />
            <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/Screen%2BShot%2B2021-04-19%2Bat%2B11.59.54%2BAM.png' style={{ width: 300 }} />
          </Card>
        </Col>
      </Row>
    </>

      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            {/* Core Products */}
            <h1>Core Products</h1>
            <p>A core product is a single unique product that may be added into a <a href='/help/products/createbundlekit' className='helplink'>bundle or kit</a>. If the answer to this question: <i>"Does the product I am selling contain an item within it that I order individually from my supplier?"</i> is "no", then you have a core product.</p>
            ...
            <Alert 
              ...
              type="info" 
            />
            <img src="https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/product9%2B_1_.png" style={{ width: 500 }}/>

      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            <p><b>Example:</b> Field Replacements under the Company section for a packing slip template</p>
            ...
            <p><b>Example:</b> These orders have not had any units of this SKU picked because the Picked quantities are all 0.</p>
            ...
            <p>You can edit the <b>PO Number Prefix</b> and <b>Auto PO Generation</b> settings.</p>
            ...
            <ul>
              <li><b>PO Number Prefix:</b> Any number or text that you input here will be appended to the beginning of all non-dropship purchase order numbers generated by Extensiv Order Manager.</li>
              <li><b>Auto PO Generation:</b> Selecting this checkbox will enable Extensiv Order Manager to generate Auto POs, which will be visible in the Awaiting Authorization Status in the <b>Purchasing</b> module.</li>
            </ul>
            ...
            <p><b>Automatically update product weight and dimensions from shipped orders?:</b> Checking this setting will automatically update the weight and dimensions of a product based on the weight and dimensions of the most recent shipped order that contained a single unit of the product.</p>
            
            <h2>Inventory Settings Section</h2>
            <p>You can edit the <b>Inventory Update</b> setting and the default auto-reorder rules that will be assigned to any new products that are created after these settings have been updated.</p>
            ...
            <ul>
              <li><b>Inventory Update:</b> This checkbox enables Extensiv Order Manager to push inventory to all active sales channels with active listing SKUs that have the "Push inventory to channel" setting enabled. <b>⚠️ Note: DO NOT TOUCH THIS SETTING WITHOUT CONSULTING YOUR IMPLEMENTATION MANAGER, ACCOUNT MANAGER, OR Extensiv Order Manager SUPPORT.</b></li>
              <li><b>Auto Reorder Sales Days Back Default:</b> The number of days that Extensiv Order Manager will use to calculate the sales velocity of a product.<br/>
              <b>Auto Reorder Days In Stock Default:</b> The number of days that you want the product to be in stock for once it's been reordered.</li>
              <li><b>Auto Reorder Growth Percentage Default:</b> The expected percentage change in the sales velocity for a product. This can be a positive or negative number.</li>
              <li><b>Auto Reorder Lead Days Buffer Default:</b> The number of days that you want to add to the lead time of the product as a buffer.</li>
            </ul>
            ...
            <p><b>Choose from all Vendors for reconciliation?:</b> Enables you to reconcile bundles based on the vendor products of the core components. To enable this setting, select its checkbox and click on the Update <b>button</b> at the bottom of the page.</p>
            ...
            <p><b>Automated Returns Receiving Warehouse:</b> This setting will determine what the Receiving Warehouse is for any automatically generated RMAs (such as those created from webhooks). Read on here to learn more about returns webhooks and their default warehouse settings for RMAs.</p>

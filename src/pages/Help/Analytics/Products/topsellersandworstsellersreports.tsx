...
export default function () {
  return (
    <>
      <h2>
        Analytics {'>'} Products {'>'} Top Sellers & Worst Sellers Reports
      </h2>
      <Row>
        <Col span={24}>
          <Card>
            ...
            <br />
            <img
              src="https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2503836/Screen_Shot_2021-02-24_at_1.02.29_PM.png"
              style={{ width: 1000 }}
            />
            <br />
            <br />
            ...
            <Alert description="The timezone for these reports is UTC." />
            <br />
            <h1>Choose the data you want to review:</h1>
            <br />
            <img
              src="https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2503838/Screen_Shot_2021-02-24_at_1.18.54_PM.png"
              style={{ width: 400 }}
            />
            <br />
            <br />
            ...
            <ul>
              <li>
                <p>
                  <strong>Units Sold:</strong> The total number of units that were shipped.
                </p>
              </li>
              <li>
                <p>
                  <strong>Revenue:</strong> The total amount of revenue per product.
                </p>
              </li>
              <li>
                <p>
            ...
            <p>
              These reports are exportable as Microsoft Excel spreadsheets. To{' '}
            ...
            <br />
            <img
              src="https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2503843/Screen_Shot_2021-02-24_at_1.27.01_PM.png"
              style={{ width: 400 }}
            />
            <br />
            <br />

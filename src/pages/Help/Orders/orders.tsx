  ...
  return (
    <>
      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            <p>To reprint a shipping label in Extensiv Order Manager, head to the <strong>Orders</strong> module.</p>
            <br />
            <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2504570/orders1__3_.png' style={{ width: 1000 }} />
            <br /><br /><br />
            <ol>
              <li>
                <p>In the <strong>Orders</strong> module, search for the order or filter your view to only include orders in the <strong>Shipped</strong> status. To learn more about searching for orders and/or filtering orders by status, see <a href="" className='helplink'>How to Search and Filter Orders</a>.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2504592/orders1__4_.png' style={{ width: 200 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>If you search for the order, click into the row. If you filtered orders by the Shipped status, select the checkbox next to the order. Next, click the <strong>Print</strong> button and select <strong>Label(s)</strong> from the dropdown.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2504594/orders1__5_.png' style={{ width: 800 }} />
                <br /><br /><br />
                <Alert
                    message="NOTE"
              ...
              <li>
                <p>The shipping label will open in a new browser window. From there, you can either print or download the label.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2504595/orders1__6_.png' style={{ width: 300 }} />
              </li>
            </ol>
          </Card>
        </Col>
      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            <p>Orders that are not processed through Extensiv Order Manager's Shipping module need to be manually marked as shipped. This feature can also be used for orders of digital products that do not need to have a physical shipment sent. You can make this edit on orders individually or in bulk.</p>
            <br />
            <Alert
                message="NOTE"
                description={
                  <p>Orders in Unresolved, Pending Multi-Channel Fulfillment, Shipped, On Hold, or Cancelled status <strong>cannot</strong> be marked as shipped.</p>
                }
                type="info"
            />
            <br />
            <p>In addition, Extensiv Order Manager's <strong>External Shipment Import</strong> feature offers an alternative method, one that requires you to configure the name mappings for your sales channels and shipping carriers. To learn more about using the External Shipment Import feature to mark items as <i>shipped</i> in bulk, see <a href="" className='helplink'>Importing External Shipments</a>.</p>
            ...
            <ol>
              ...
              <li>
                <p>By default, the <strong>Orders</strong> Module displays the orders that are awaiting shipment. Select the order you want to mark as shipped using the checkboxes in the left-most column. <strong>To Bulk Mark as Shipped</strong>, select more than one order. To select all orders, select the topmost checkbox, in the Column Type row.<br />If the orders are <i>Awaiting Dropship</i> or <i>Awaiting 3PL Export</i>,click the corresponding status on the <strong>Search/Filter</strong> pane on the left, then select the orders to be marked as shipped.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/markship.png' style={{ width: 800 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Go to the Edit dropdown menu and click Mark <strong>‘Shipped.’</strong></p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/markship2.png' style={{ width: 600 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>On the <strong>Create External Shipments</strong> window, enter the tracking number and shipping carrier for the selected order, select either <strong>Yes</strong> or <strong>No</strong> to indicate whether you want to notify the customer and update the channel where the order is from, then enter the ship date. The tracking number and shipping carrier can be valid values or artificial, the choice is up to you. <i>If you use an artificial tracking number, you may not want to choose to update the customer or channel</i>.<br /><strong>To update multiple orders</strong> with the same values, populate the fields in the Bulk Selection row and all orders will automatically update with those bulk options. To input an Artificial Tracking Number specifically to apply to all orders here, enter the tracking number value, then click the triangle icon adjacent to that field as seen below.<br /><strong>Required Values:</strong> Tracking Number, Shipping Carrier, Notify Customer, Update Channel</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/markship3.png' style={{ width: 900 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Click <strong>Mark 'Shipped'</strong> to update the order(s) status to <i>Shipped</i>.</p>
              </li>
            </ol>
          </Card>
        </Col>
      ...
      <Row>
        <Col span={24}>
          <Card>
            <p>Return Merchandize Authorizations (RMAs) keep record of product returns, produce/email a return shipping label, and dictate how you want the returned inventory to be handled.</p>
            <h1>How To Create an RMA</h1>
            <ol>
              <li>
                <p>Navigate to the <strong>Orders</strong> module</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/rma.png' style={{ width: 1000 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>On the <strong>Search/Filter</strong> pane on the left, select the <strong>Shipped</strong> status dropdown view, and select a sub-status to view orders that have already been shipped.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/rma2.png' style={{ width: 200 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>In the results viewing pane, select the row or checkbox of the order that you want to create an RMA for, then click <strong>Create RMA</strong>.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/rma3.png' style={{ width: 800 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>In the <strong>Create RMA</strong> window, be sure to select the correct <strong>Return To</strong> location for the order. The options you see in this dropdown menu are based on the Active Warehouses you have in the Settings Module, as the menu will show the Returns Location for each. This setting will determine which warehouse Extensiv Order Manager associates the return with as well as the shipping address on the return shipping label (if you choose to include a return label).</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/rma5.PNG' style={{ width: 300 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>You can create an RMA with or without a return shipping label. You indicate this through the checkmark box stating <strong>This RMA includes a shipping label</strong>. The information required to make the RMA will vary depending on whether or not you include the shipping label. <i>If you do not select this option, you can skip to Step 6.</i>. <br />If you choose to include a return shipping label, you can choose whether or not you'd like to email someone the return label. If you'd like to email the return label, the checkbox <strong>Email Label?</strong> needs to be enabled. An email address to send the return label is also required. The return shipping label will be emailed when the RMA is completed.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/rma4.PNG' style={{ width: 600 }} />
                <br /><br /><br />
                <p>Enter all required Shipping & Measurement information if you are including a shipping label. Click <strong>Calculate Shipping Rate</strong> to rate the return shipment.</p>
                <br />
                <Alert
                    message="NOTE"
                    description={
                      <p>The settings in the <strong>Processing</strong> tab will NOT be able to be edited once the RMA is saved, except for the <strong>Internal Notes</strong>.</p>
                    }
                    type="info"
                />
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/rma6.png' style={{ width: 300 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Click the <strong>Returned Items</strong> tab and select the items for return from the list. Be sure to select both the correct product(s) and the quantity being returned.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/rma7.png' style={{ width: 600 }} />
                <br /><br /><br />
                <p>Then indicate how you want the returned item(s) to be handled within Extensiv Order Manager. The Type and Reason are for recording purposes only, while the Action setting will directly determine what happens to the inventory counts when the RMA is "Received". Setting the Action to "Write Off" will result in no inventory adjustments, while selecting one of the "Reinsert" options will result in the returned units being added back to On Hand stock at the "Return To" Warehouse once the RMA is Received.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/shipments.png' style={{ width: 600 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Click <strong>Save</strong>.</p>
            ...
            <ol>
              <li>
                <p>In the <strong>Shipments</strong> Module, go to the <strong>Search/Filter</strong> pane on the left and select the <strong>Returns</strong> dropdown view, and select the relevant warehouse or use the Search option to search Returns for a particular RMA.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/shipments%2B_1_.png' style={{ width: 1000 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Once you've located your RMA, you can edit the items that are going to be received as well as what Action they will have by clicking the RMA Number hyperlink. You can indicate a Loss to Seller amount as well.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/shipments%2B_2_.png' style={{ width: 1000 }} />
                <br /><br /><br />
                <Alert
                    message="NOTE"
                    description={
                      <p>Extensiv Order Manager does not issue refunds to your customers. Any indication of a refund for a return or exchange is strictly for record-keeping purposes only.</p>
                    }
                    type="info"
                />
                <br />
              ...
              <li>
                <p>Once the Returned Items information is finalized, you can choose to generate the return shipping label if it's needed by selecting the row/checkbox of your RMA and then click the <strong>Print Labels</strong> button.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/shipments%2B_4_.png' style={{ width: 900 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Finally, once a return has been received at your Returns warehouse, or once you want to "close out" an RMA (ie: if the customer will not be shipping the item back), select the RMA row/checkbox and then click the Mark as Received button. You will be prompted with a confirmation window which reminds you that Inventory will be handled according to the "Action" indicated in the Returned Items window.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/shipments%2B_5_.png' style={{ width: 900 }} />
                <br /><br /><br />
              </li>
            </ol>
            <p>Once you confirm, your RMA will be "Received" which is indicated in the "Confirmation" column. If you selected the "Reinsert" Action option, your product will have been added to the On Hand inventory count at the Return To/Return Location warehouse.</p>
          </Card>
        </Col>
      </Row>
      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            <p>Any orders that have a Master SKU with not enough stock to fulfill an order will be in the Unresolved - Out of Stock order status. To resolve these orders, you with either need to add inventory in the warehouse for the item that is out of stock or change the fulfillment to a warehouse that has stock.</p>
            <p>To resolve the issue by adding inventory, follow the steps below.</p>
            <ol>
              <li>
                <p>Select the <strong>Orders</strong> module on the Toolbar. Within the "Filter By" pane on the left, expand the <strong>Unresolved</strong> status filter to see the <strong>Out of Stock</strong> status. Then click the order you wish to resolve (click on the order line, not the blue hyperlink).</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2503658/orders__24_.PNG' style={{ width: 900 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>On the <strong>Order Items</strong> panel at the bottom, note that there is an Out of Stock error message on the Master SKU that is out of stock at the currently assigned warehouse. Take note of the Master SKU since you will be adding more of this SKU to your inventory in Step 4 below.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2503661/orders__25_.PNG' style={{ width: 800 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>On the <strong>Order Fulfillment</strong> panel on the right, take note of the fulfillment method and source. You will need these to complete Step 6 below.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2503665/orders__26_.PNG' style={{ width: 200 }} />
                <br /><br /><br />
                <p>For Steps 4-6, you will go to the <strong>Inventory module</strong>.</p>
              </li>
              <li>
                <p>On the Toolbar, click Inventory, then enter the SKU in the search bar.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2503668/inventory__8_.png' style={{ width: 800 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>The Master SKU record appears on the <strong>Search Results</strong> panel immediately below the search bar. Click the record to display the <strong>Stock Details</strong> panel on the right.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2503669/inventory__9_.png' style={{ width: 900 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Look for the fulfillment method and source on the <strong>Stock Details</strong> panel. You will need to add or adjust stock to the source to resolve the order. For instructions on how to do this, see <a href="" className='helplink'>Manually Adding to a Product's Stock</a>.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2503670/inventory__10_.png' style={{ width: 400 }} />
                <br /><br /><br />
              </li>
            </ol>
            <p>Once you add stock to the source, Extensiv Order Manager will allocate a stock item and resolve the</p>
            <p>issue with the order. To check, go back to the Orders module, where the order should have been resolved and should be <i>Awaiting Shipment, Awaiting 3PL Export, or Awaiting Dropship</i>, depending on the order's fulfillment method and source.</p>
            <p>Note that Extensiv Order Manager allocates inventory to the oldest orders first in a FIFO (First In First Out Method)</p>
          </Card>
        </Col>
      </Row>
      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            <p>In addition to downloading orders from external sales channels, manual orders can also be created within Extensiv Order Manager. To create a manual order, follow the steps below.</p>
            <ol>
              <li>
                <p>In the <strong>Orders</strong> module, click the <strong>New Order</strong> button and select the manual orders sales channel that you want to create this order for</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2504058/orders__30_.PNG' style={{ width: 800 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>In the <strong>New Manual Order</strong> window, enter the required fields. The required fields are <strong>Name, Address Line 1, City, State, Zip Code, Country, and Order Number.</strong></p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2504060/orders__31_.PNG' style={{ width: 700 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Click into the <strong>Add Item</strong> dropdown, select SKUs to add to the order, and click into the <strong>Quantity</strong> field to input the order item quantities.</p>
                <br />
              </li>
            </ol>
            <p>Alternatively, you can utilize the Paste From CSV button to set the order items in bulk. This is mostly helpful for large orders with many different SKUs.</p>
            <p>To <strong>Paste from CSV</strong>, you will be prompted after click the button to input the Listing SKU, Quantity, and Unit Price. Each item should be its own row, with the 3 inputs separated by commas. Make sure that your Unit Price input is formatted as dollars & cents. Setting a single digit with no decimal points will result in an error message.</p>
            <p><strong>Example:</strong> ABC,4,2.00</p>
            <p>The result would be adding 4 units of Listing SKU ABC for the channel selected, each at a Unit Price of $2.</p>
            <p>After entering the required fields and adding order items, click the <strong>Save</strong> button to create the order. If the order is being fulfilled at an in-house warehouse, you can create the shipping label from the <strong>Awaiting Shipment</strong> status. For more info, see <a href="" className='helplink'>Shipping Orders</a>. If the order is being fulfilled at a 3PL warehouse or dropshipper, you can export the order from the <strong>Awaiting 3PL Export</strong> status for fulfillment.</p>
          </Card>
        </Col>
      </Row>
      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            <p>When an order is tagged as an <i>Unresolved Order - Missing Fulfillment Source</i>, it means that at least one Master SKU in the order does not have a pickable stock location at the warehouse assigned to fulfill the order.</p>
            <p>To resolve these orders, you need to select a different fulfillment source with existing stock of the Master SKUs OR add stock to the assigned warehouse for the order item(s) that are out of stock. To do this, follow the steps below:</p>
            <br />
            <h1>Option 1</h1>
            <br />
            <ol>
              <li>
                <p>Click <i><strong>Orders</strong></i> on the Toolbar, select <strong>Unresolved {'>'} Missing Fulfillment Source</strong> on the <strong>Search/Filter</strong> panel to view all orders, then click the order number that appears in the grid to the right.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2504406/orders__32_.PNG' style={{ width: 900 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>In the <strong>Order Details</strong> window, click the <strong>Processing</strong> tab, select a different fulfillment method and source, then review the other information for completeness.</p>
              </li>
              <li>
                <p>Click <strong>Save</strong>.</p>
              </li>
            ...
            <br />
            <p>Once you change the fulfillment source to a warehouse with stock of the Master SKU, Extensiv Order Manager will allocate a stock item and resolve the issue with the order. To check, go back to the <strong>Orders</strong> module, where the order should have been resolved and in an <i>Awaiting</i> status.</p>
            <br />
            <h1>Option 2</h1>
            <br />
            <p>Create or add stock at a new or existing stock location. If the warehouse assigned is an in-house warehouse, you'll need to ensure the stock location is pickable.</p>
            <p>See this article for instructions on <a href="" className='helplink'>how to create a stock location</a> with inventory via Extensiv Order Manager's UI.</p>
          </Card>
        </Col>
      </Row>
      ...
      <Row>
        <Col span={24}>
          <Card>
            <p>When an order is in an Unresolved {'>'} Missing Order Info status, this means that crucial information regarding the order (name, address, city, state, or zip code) is missing. </p>
            <p>To see exactly what information is missing, go to the Orders module, click on the <strong>'Unresolved'</strong> dropdown, and then <strong>'Missing Order Info'</strong>. This will display all unresolved orders with this error. You can view and update this information from the 'Order Fulfillment' pane on the right, and click <strong>'Recipient'</strong>.</p>
            <p>This status is rare, as most sales channels require this information to be entered by the customer before the order is placed on their platform. Nonetheless, if you have an order in this status, you will not be able to ship it until you have input this information.</p>
            <br />
            <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/image%2B_35_.png' style={{ width: 500 }} />
          </Card>
        </Col>
      </Row>
      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            <p>When pulling orders in from your native sales channels, Extensiv Order Manager flags orders without a payment status as <i>Awaiting Payment</i>. Extensiv Order Manager pauses these orders until it gets confirmation from the sales channels that the order has been paid (Extensiv Order Manager checks for payment status every time it pulls in data from your sales channels).</p>
            <p>When the order is updated with payment information, it will move to <i>Awaiting Shipment, Awaiting MC Fulfillment, or Awaiting 3PL Export</i>.</p>
            <p>You can manually resolve Awaiting Payment orders within Extensiv Order Manager in order to ship them. There are two ways you can accomplish this:</p>
            <ol>
              <li>
                <p>Go to the <strong>Orders</strong> module.</p>
              </li>
              <li>
                <p>In the order status panel, view the <strong>Awaiting Payment</strong> orders.</p>
              </li>
              <li>
                <p>The first option is to select the order to add payment information on by clicking on the checkbox of the order. Then select the Edit dropdown menu and select the <strong>Mark Paid</strong> option.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2504818/Screen_Shot_2021-03-18_at_10.52.56_PM.png' style={{ width: 900 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Indicate the amount the customer paid, as well as the payment date. Then click the <strong>Save</strong> button. The order should move to an Awaiting status (Shipment, 3PL Export, or Dropship).</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2504819/Screen_Shot_2021-03-18_at_10.58.37_PM.png' style={{ width: 900 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Alternatively, you can add the payment details in the <strong>Order Details</strong> window. Click the order number hyperlink and set the Amount Paid as well as the Date Paid, then click <strong>Save</strong>. The result will be the same with either method you choose.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/2504820/Screen_Shot_2021-03-18_at_10.55.58_PM.png' style={{ width: 900 }} />
              </li>
            </ol>
          </Card>
        </Col>
      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            <p>After adding a manual sales channel and linking your listing SKUs to a master SKU, you can start importing your orders into the channel.</p>
            <p>To import orders manually, follow the procedure below.</p>
            <ol>
              <li>
                <p>Open the <strong>Orders</strong> Module.</p>
              </li>
              <li>
                <p>Click the <strong>Import/Export</strong> drop-down menu, then select <strong>Import Orders</strong>.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/import1.png' style={{ width: 800 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>In the <strong>Manual Order Import</strong> window, click <strong>Configure</strong>.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/import2.png' style={{ width: 600 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>In the <strong>Order Import Settings</strong> window, click <strong>New Settings</strong>.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/import%2B_1_.PNG' style={{ width: 500 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>In the <strong>New Import Settings</strong> window, give your settings a title in the Settings Name field. A descriptive name would be best, e.g. <i>Import_All_Fields</i>, or September 2020 Settings.</p>
              </li>
              <li>
                <p>Select the file format from the CSV and Text options, select the structure, and the date format.</p>
              </li>
              <li>
                <p>Add and/or organize the Data Fields you'd like to use. Ensure that every Data Field has a corresponding Column Name that you'll be able to recognize in your Import File. To reorder Data Fields, drag and drop them.<br /> Some Data Fields are required both in the Configuration and in the actual import file.</p>
                <ul>
                  <li>
                    <p>Customer Name</p>
                  </li>
              ...
              <li>
                <p>If you want to make column headers required, make sure to check the <strong>Include column headers</strong> box.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/import4.PNG' style={{ width: 700 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Once you're satisfied with your configurations, click <strong>Save</strong> to close the <strong>Import Settings</strong> window.</p>
              </li>
              <li>
                <p>Back in the <strong>Order Import Settings</strong> window, the new settings are now added to your Settings list. Click <strong>Close</strong> to close the Order Import Settings window and go back to the <strong>Manual Order Import</strong> window.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/import%2B_2_.PNG' style={{ width: 500 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Now you'll need to create either a CSV or Text file according to the file format you chose in your configuration settings, and input your orders to import in the exact column format that matches your configuration settings as well.</p>
                <Alert
                  message="The row headers and configuration settings are case-sensitive."
                  description={
                    <p>Any deviation to the file format will cause import issues, including if you do/don't include the row headers. These issues could be caused by having more columns than your configuration settings to have Data Fields, or putting a Date input in a column that was configured for an amount of money (like Amount Paid). Make sure to double-check that any date text is in the exact format matching your configurations and that all required fields are filled in. Make sure your file is saved in the right file format.</p>
                  }
                  type="warning"
                />
                <br />
                <Alert
                  ...
                  description={
                    <p>Example: if 1 order has 2 items, there should be 2 lines on the spreadsheet to notate that both line items belong to the same order number.</p>
                  }
                  type="warning"
                />
                <br />
              ...
              <li>
                <p>Back in the <strong>Manual Order Import</strong> window, click the <strong>Import Settings</strong> dropdown menu and select the settings you just created. Set the Manual Sales Channel to the correct channel. Then click the <strong>Select</strong> button and choose the CSV or Text file from your computer to import. Click <strong>Continue</strong> to start uploading the file into Extensiv Order Manager.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/import6.PNG' style={{ width: 400 }} />
                <br /><br /><br />
                <p>Extensiv Order Manager will then start processing the import file. The speed with which the process runs and completes depend on the number of manual orders to be imported into Extensiv Order Manager. If an Error Log is generated, ensure that the rows with issues detected are addressed. If there is a general error that the file could not be uploaded, there is likely an issue with the number and order of columns in your file not matching the Configuration Settings exactly, or the presence or lack thereof of Headers, or the file format itself is incorrect. Double-check your settings and file until an Error Log is produced and notifies you that your import was completely successful.</p>
              </li>
            </ol>
          </Card>
        </Col>
      ...
      <Row>
        <Col span={24}>
          <Card>
            <p>When an order is in the Missing Fulfillment Source status, this is usually caused by an issue with the Recipient information.</p>
            <p>Under the Order Fulfillment pane, select <strong>Recipient</strong> and review the address that was entered. You can either update the address manually and <strong>save</strong>, or force validate the address by selecting <strong>Validate</strong>. This can cause an order to be unresolved if it does not have required shipping information such as a state/country/postal code.</p>
            <br />
            <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/image%2B_37_.png' style={{ width: 800 }} />
          </Card>
        </Col>
      </Row>
      ...
      <Row>
        <Col span={24}>
          <Card>
            <p>When shipping internationally, customs forms need to be as accurate as possible to ensure your shipment(s) successfully go through a customs inspection in the country of destination. Specific information must be included on the document, such total weight of the shipment. Total weight is verified in Order Info and Product Info.</p>
            <p>It's common to see the error message <strong>"Weight cannot be less than the total customs item weight"</strong>, which indicates a weight discrepancy. The package weight listed in the "Product Basic Info" must be greater than or equal to the total weight of the package in the "Customs Declarations" line items. If the package weight is too low, then this error will be returned.</p>
            <p>To correct this error, you will need to verify and edit a few fields on the Order Info page.</p>
            <ol>
              <li>
                <p><strong>Verify and update the <i>Weight</i> in the "Customs Declarations" section</strong>. If there are multiple line items, the weight of each item can be adjusted individually.</p>
              </li>
              <li>
                <p><strong>Verify and update the package <i>Weight</i> in the "Order Fulfillment" section</strong>. If the contents are packed, weigh the package to see if it weighs as much as the "Customs Declarations" weight. If the package is not packed, determine the weight of the packing materials. Calculate the package weight by adding this to the "Customs Declarations" weight.</p>
              </li>
            </ol>
            ...
            <ol>
              <li>
                ...
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/customs.png' style={{ width: 600 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Go to the Customs tab.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/customs%2B_1_.png' style={{ width: 700 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Click the entry under Weight (oz) to change the weight value.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/customs%2B_2_.png' style={{ width: 700 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Hit Save.</p>
            ...
            <ol>
              <li>
                ...
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/customs%2B_4_.png' style={{ width: 800 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Within the Order Fulfillment Section, to the right hand side of the page, locate the Measurements field.</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/customs%2B_5_.png' style={{ width: 200 }} />
                <br /><br /><br />
              </li>
              <li>
                <p>Type in the correct weight. Hit Save</p>
                <br />
                <img src='https://static.helpjuice.com/helpjuice_production/uploads/upload/image/12985/direct/customs%2B_6_.png' style={{ width: 200 }} />
                <br /><br /><br />
              </li>
            </ol>
          </Card>

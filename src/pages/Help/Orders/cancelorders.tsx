      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            <p>Orders that are in <b>Awaiting Shipment or Pending Fulfillment</b> can be canceled.</p>
            ...
            <ol>
              ...
              <li>
                  <p>Search for the order you want to cancel using the <b>Search/Filter</b> panel on the left.<br />For more details on how to search for orders, see <a href='' className='helplink'>Searching for Orders</a>.</p>
              ...
              <li>
                  <p>Lastly, click the <b>Yes - Cancel Order</b> button to confirm the cancellation.</p>
              </li>
            </ol>
          </Card>
        </Col>

      ...
      <Row>
        <Col span={24}>
          <Card>
            ...
            <p>With Extensiv Order Manager's <strong>Customer</strong> module, you do not need to maintain a separate and expensive customer relationship management system. The <strong>Customer</strong> module allows you to:</p>
            <ul>
            ...
            <p>The <strong>Customer</strong> module has a search/filter panel on the left, the main customer record in the middle, the customer's details on the right, and the customer orders at the bottom. You have to select a customer record first before the customer's details and order record is displayed onscreen.</p>
            ...
            <p>If you have 2 different aliases for a customer (ex. John and John Peak in the screenshot below) you can select <strong>Merge</strong> from the top menu to combine these. Click <strong>Merge</strong> and drag the customer you wish to be the "Master" which has the most up to date address and email, and then select each customer you would like to merge into the Master. Once complete, select Merge at the bottom</p>
            ...
            <p>To add new customers, simply click New Customer from the top menu and enter the necessary Name and Company (optional). Then click <strong>Save</strong></p>
            ...
            {/* View History */}
            <h1>View History</h1>
            <p>You can also see the edit history per specific customer by selecting <strong>History</strong> from the top menu</p>

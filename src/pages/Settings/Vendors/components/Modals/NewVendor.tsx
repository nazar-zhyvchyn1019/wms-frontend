          ...
          <Col span={12}>
            <Card title="Basic Info" style={{ padding: '0.5rem' }}>
              ...
              <Row>
                ...
                <Col span={20}>
                  <TextArea rows={3} onChange={(e) => handleInputChange('address', e.target.value)} />
                </Col>
              </Row>
              <Row>
              ...
              <Row>
                ...
                <Col span={20}>
                  <Input placeholder="Phone 1" onChange={(e) => handleInputChange('phone1', e.target.value)} />
                </Col>
              </Row>
              <Row>
                <Col span={4}>Phone 2</Col>
                <Col span={20}>
                  <Input placeholder="Phone 2" onChange={(e) => handleInputChange('phone2', e.target.value)} />
                </Col>
              </Row>
              <Row>
                ...
                <Row>
                  <Col span={24}>
                    <Row align="middle" style={{ justifyContent: 'start' }}>
                      ...
                      <Col span={22}>
                        <Checkbox onChange={(e) => handleInputChange('is_manufacturer', e.target.checked)}>

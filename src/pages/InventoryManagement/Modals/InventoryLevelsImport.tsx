...
const InventoryLevelsImportModal: React.FC<IInventoryLevelsImportModal> = ({
  isOpen,
  onClose,
  onSave,
  warehouseName,
  ...
  return (
    ...
    >
      <div style={{ fontSize: 14 }}>
        <p>
          To configure the stock quantities at which Skubana will send alerts to reorder a
          particular product within a warehouse, simply set your minimum inventory levels
        </p>

        <p>
          Batch imports of minimum inventory levels for a warehouse are done through the Microsoft
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ marginRight: 10 }}>
            Update existing stock if changes found in the Excel file?
          </div>
          <Select
            options={[

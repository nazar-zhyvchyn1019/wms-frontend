  ...
  return (
    <div>
      <Row justify="space-between" align="middle" >
        ...
        <Col>
          <Button icon={searchType ? <DoubleRightOutlined rotate={270} /> : <DoubleRightOutlined rotate={90} />} onClick={() => setSearchType(!searchType)} size="large" ghost style={{ border: 'none' }}>
            <SearchOutlined />
          </Button>
        </Col>
      </Row>
      <div>
        {searchType ? <SearchByProductPanel /> : <SearchByCategoriesPanel />}
      </div>
    </div >
  );
}

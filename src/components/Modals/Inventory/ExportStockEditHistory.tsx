  ...
  return (
    ...
    >
      <>
        ...
        <p>
         To download your stock edit history, select the warehouse and click 'Export' button. The export will include stock edit history available in Skubana from within the last 6 months. Please allow the time necessary for the excel file to be generated and emailed to you. 
        </p>

export default {
  ...
  'pages.products.mainPage.title': 'Products',
  'pages.products.mainPag.convertToBundleKit.title': 'Sure to convert to bundle/kit?',
  'pages.products.mainPag.convertToCore.title': 'Sure to convert to Core?',
  'pages.products.mainPag.deactivate.title': 'Sure to Convert to Deactivate?',
  'pages.products.mainPag.activate.title': 'Sure to Convert to activate?',
  'pages.products.newProductSelectType.title': 'New Product',
  'pages.products.newProductSelectType.selectType': 'Select Type',
  'pages.products.newProductSelectType.question': "What's the difference",
  ...
  'pages.products.coreProduct.basicInfo.ownBox': 'Own Box',
  ...
  'pages.products.coreProduct.gallery.description': 'Manage images by adding, removing and/or dragging each image to create an ordered gallery.',
  ...
  'pages.products.coreProduct.bundleItems.description': 'Manage cord products and their respective quantities within this bundle/kit',
  ...
  'pages.products.coreProduct.variationDetails.description2': 'Create your Core product variations below by clicking on the + symbol',

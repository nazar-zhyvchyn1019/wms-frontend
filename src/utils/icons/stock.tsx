...
const StockSvg = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em" height="1em">
    <g transform="translate(0 -1028.4)">
      ...
      <path
        d="m1.1875 1044.4v7h22v-7h-8.188c-.416 1.1-1.511 2-2.812 2-1.302 0-2.3975-.9-2.813-2h-8.1875z"
        fill="#f1c40f"
      />
      <path d="m1.1875 1051.4h22v1h-22z" fill="#f39c12" />
      <path
        d="m9 0v1 5.9688h-3l6 6.5312 6-6.5312h-3v-5.9688-1z"
        fill="#34495e"
...
const StockIcon = (props: Partial<CustomIconComponentProps>) => (
  <Icon component={StockSvg} {...props} />
);
